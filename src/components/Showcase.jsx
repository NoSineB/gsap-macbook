        ...
        <div className="wrapper">
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              ...
              <p>
                It drives Apple Intelligence on iPad Pro, so you can write, createt  and accomplish more ease. All in a design that's unbelieveably thin, light and powerful.
              </p>
              <p>
              ...
              <p className="text-primary">
                Learn mote about Apple Intelligence
              </p>
            </div>
          </div>
